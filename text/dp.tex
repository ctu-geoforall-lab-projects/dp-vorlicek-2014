...
Pokud je zobrazování geografických dat hlavní náplní aplikace, je lepší použít specializovanou aplikaci. Vytvoření takové aplikace vyžaduje mnohem více času a znalostí. 
	...
	\paragraph{} Cíle této práce lze shrnout do několika hlavních bodů. %% změnit na vlastnosti a ne cíle
		\begin{itemize}
...
\chapter{Vývoj aplikace}
		\section{Databáze}
Databáze je důležitým prvkem aplikace \uv{Toulavej} -- jsou zde uloženi registrovaní uživatelé, příspěvky v diskuzi a další data včetně dat OpenStreetMap.
