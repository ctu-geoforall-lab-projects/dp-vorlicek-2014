...
function init(params) {
	...
	OpenLayers.Feature.Vector.style['select']['strokeColor'] = 'rgb(0,0,255)';
	...
	var newPhoto = new OpenLayers.Layer.Vector("Nová fotka", {
		projection: new OpenLayers.Projection("EPSG:900913")
	});
	map.addLayer(newPhoto);
...
//map.addControl(new OpenLayers.Control.LayerSwitcher()); //layer switcher
	...
	controls = {
		point: new OpenLayers.Control.DrawFeature(newPhoto, OpenLayers.Handler.Point),
		modify: new OpenLayers.Control.ModifyFeature(newPhoto)
	};
